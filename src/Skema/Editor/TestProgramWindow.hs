...
import Graphics.UI.Gtk.Scrolling.ScrolledWindow( scrolledWindowNew, scrolledWindowAddWithViewport )
...
createIOControl box pt = do
  ...
  createEntry hbox0 $ iopDataType pt
...
createEntry :: BoxClass b => b -> IOPointDataType -> IO ()
...
createNEntries :: BoxClass b => b -> IOPointDataType -> Int -> IO ()
